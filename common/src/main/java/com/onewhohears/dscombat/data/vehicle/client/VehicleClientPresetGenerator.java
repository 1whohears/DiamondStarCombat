...
public class VehicleClientPresetGenerator extends JsonPresetGenerator<VehicleClientStats> {
	...
	protected void registerPresets() {
		...
		addPresetToGenerate(VehicleClientStats.Builder.create(DSCombatMod.MODID, "alexis_plane")
				...
				.addUIPos("left_tech_mount", alexis_middle_x-20, 21)
				.addUIPos("right_tech_mount", alexis_middle_x+20, 21)
                .addUIPos("frame_1", alexis_middle_x, alexis_wing_y)
		...
		addPresetToGenerate(VehicleClientStats.Builder.create(DSCombatMod.MODID, "javi_plane")
                ...
                .addUIPos("left_tech_mount", javi_middle_x-10, 27)
                .addUIPos("right_tech_mount", javi_middle_x+10, 27)
		...
		addPresetToGenerate(VehicleClientStats.Builder.create(DSCombatMod.MODID, "mrbudger_tank")
				...
				.setCustomAnims("t72hull", VehicleAnimsBuilder.create()
						...
						.addWheelRotPixelAnim("w10", 24.9375f, 7.05f, 25.2f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w11", 24.9375f, 7.05f, 10.5f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w12", 24.9375f, 7.05f, -4.2f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w13", 24.9375f, 7.05f, -18.9f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w14", 24.9375f, 7.05f, -33.6f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w15", 25.452f, 14.19f, 50.82f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w16", 25.452f, 12.09f, -44.94f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w1", -24.9375f, 7.05f, 39.9f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w2", -24.9375f, 7.05f, 25.2f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w3", -24.9375f, 7.05f, 10.5f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w4", -24.9375f, 7.05f, -4.2f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w5", -24.9375f, 7.05f, -18.9f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w6", -24.9375f, 7.05f, -33.6f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w7", -25.452f, 14.19f, 50.82f, RotationAxis.X, wheel_rot_rate)
						.addWheelRotPixelAnim("w8", -25.452f, 12.09f, -44.94f, RotationAxis.X, wheel_rot_rate)
						.build())
