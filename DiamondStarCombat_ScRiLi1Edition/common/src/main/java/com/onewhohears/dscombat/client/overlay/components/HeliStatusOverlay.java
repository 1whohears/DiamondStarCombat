...
public class HeliStatusOverlay extends VehicleOverlayComponent {
    ...
    protected void render(Gui gui, GuiGraphics graphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        graphics.drawString(FONT, String.format("RPM: %3.0f%%", rpm), x, y, TEXT_COLOR);
        y += 10;
        ...
        graphics.drawString(FONT, "IGE: " + (ige ? "ON" : "OFF"), x, y, ige ? TEXT_COLOR : OFF_COLOR);
        y += 10;
        ...
        graphics.drawString(FONT, "ETL: " + (etl ? String.format("%d%%", (int)(etlFactor*100)) : "OFF"), x, y, etl ? WARN_COLOR : OFF_COLOR);
        y += 10;
        ...
        graphics.drawString(FONT, "VRS: " + (vrs ? "ENGAGED" : "OK"), x, y, vrs ? DANGER_COLOR : TEXT_COLOR);
    }
