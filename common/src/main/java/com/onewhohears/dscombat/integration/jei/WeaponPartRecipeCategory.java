...
public class WeaponPartRecipeCategory implements IRecipeCategory<WeaponPartRecipe> {
	...
	public final static ResourceLocation UID = new ResourceLocation(DSCombatMod.MODID, "weapon_part_workbench");
	public static final RecipeType<WeaponPartRecipe> TYPE = RecipeType.create(UID.getNamespace(), UID.getPath(), WeaponPartRecipe.class);
