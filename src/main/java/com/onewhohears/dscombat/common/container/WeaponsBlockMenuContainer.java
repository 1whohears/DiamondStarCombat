...
public class WeaponsBlockMenuContainer extends AbstractContainerMenu {
	
	private WeaponsBlockEntity weaponsBlock;
	private BlockPos pos;
	private boolean loaded = false;
	
	public WeaponsBlockMenuContainer(int windowId, Container playerInv, WeaponsBlockEntity weaponsBlock) {
