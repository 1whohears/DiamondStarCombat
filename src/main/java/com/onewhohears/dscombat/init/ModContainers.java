...
public class ModContainers {
	...
	public static final RegistryObject<MenuType<AircraftBlockContainerMenu>> AIRCRAFT_BLOCK_MENU = 
			register("aircraft_block_menu", (IContainerFactory<AircraftBlockContainerMenu>) (windowId, playerInv, data) -> {
				AircraftBlockEntity aircraftBlock = (AircraftBlockEntity)playerInv.player.level.getBlockEntity(data.readBlockPos());
				return new AircraftBlockContainerMenu(windowId, playerInv, aircraftBlock);
			});
