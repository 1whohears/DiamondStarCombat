...
public class ModArgumentTypesForge {

    public static final DeferredRegister<ArgumentTypeInfo<?,?>> ARGUMENT_TYPES = DeferredRegister.create(
            ForgeRegistries.COMMAND_ARGUMENT_TYPES, DSCombatMod.MODID);

    public static void register(IEventBus eventBus) {
        ARGUMENT_TYPES.register(eventBus);
    }

    public static final RegistryObject<ArgumentTypeInfo<?,?>> WEAPON_PRESET = ARGUMENT_TYPES.register(
            "weapon_preset", () -> ArgumentTypeInfos.registerByClass(WeaponArgument.class,
                    SingletonArgumentInfo.contextFree(WeaponArgument::weapon)));

    public static final RegistryObject<ArgumentTypeInfo<?,?>> VEHICLE_PRESET = ARGUMENT_TYPES.register(
            "vehicle_preset", () -> ArgumentTypeInfos.registerByClass(VehiclePresetArgument.class,
