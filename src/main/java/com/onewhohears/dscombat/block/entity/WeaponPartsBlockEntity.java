...
public class WeaponPartsBlockEntity extends SyncedBlockEntity implements MenuProvider {

	private NonNullList<ItemStack> inventory = NonNullList.withSize(1, ItemStack.EMPTY);

	public WeaponPartsBlockEntity(BlockPos pos, BlockState blockState) {
		super(ModBlockEntities.WEAPON_PARTS_BLOCK_ENTITY.get(), pos, blockState);
	}

	@Override
	public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
		return new WeaponPartsBlockContainerMenu(containerId, playerInventory, this);
	}
