...
public class BoatPresets {
	...
	public static final AircraftPreset EMPTY_DESTROYER = AircraftPreset.Builder
			...
			.addEmptySlot("seat5", SlotType.HEAVY_TURRET, 0, 4, 13, 0)
			.addEmptySlot("seat6", SlotType.HEAVY_TURRET, 0, 4, -10, 0)
			.addEmptySlot("frame_1", SlotType.ADVANCED_FRAME, 0, 7, 3, 0)
			.addEmptySlot("frame_2", SlotType.LIGHT_TURRET, 0, 7, 6, 0)
			.addEmptySlot("frame_3", SlotType.LIGHT_TURRET, 4, 4, -2, 0)
			.addEmptySlot("frame_4", SlotType.LIGHT_TURRET, -4, 4, -2, 0)
			.addEmptySlot("frame_5", SlotType.MED_TURRET, 4, 4, -6, 0)
			.addEmptySlot("frame_6", SlotType.MED_TURRET, -4, 4, -6, 0)
			.addEmptySlot("internal_1", SlotType.PUSH_ENGINE)
			.addEmptySlot("internal_2", SlotType.PUSH_ENGINE)
			.addEmptySlot("internal_3", SlotType.INTERNAL)
			.addEmptySlot("internal_4", SlotType.INTERNAL)
