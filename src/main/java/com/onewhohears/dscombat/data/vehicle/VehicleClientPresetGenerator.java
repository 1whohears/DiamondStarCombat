...
public class VehicleClientPresetGenerator extends JsonPresetGenerator<VehicleClientPreset> {
	
	@Override
	protected void registerPresets() {
		int alexis_middle_x = 120, alexis_wing_y = 57;
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "alexis_plane")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "javi_plane")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "noah_chopper")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "mrbudger_tank")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "small_roller")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "nathan_boat")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "andolf_sub")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "orange_tesla")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "wooden_plane")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "e3sentry_plane")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "axcel_truck")
		...
		addPresetToGenerate(VehicleClientPreset.Builder.create(DSCombatMod.MODID, "gronk_battleship")
