...
public class BulletData extends WeaponData {
	...
	public List<ComponentColor> getInfoComponents() {
		...
		list.add(new ComponentColor(new TextComponent("Damage: ").append(getDamage()+""), 0x040404));
		list.add(new ComponentColor(new TextComponent("Max Speed: ").append(getSpeed()+""), 0x040404));
		list.add(new ComponentColor(new TextComponent("Innacuracy: ").append(getInnacuracy()+""), 0x040404));
		if (isExplosive()) {
			list.add(new ComponentColor(new TextComponent("EXPLOSIVE"), 0xaa0000));
			list.add(new ComponentColor(new TextComponent("Radius: ").append(getExplosionRadius()+""), 0x040404));
		}
		if (isCausesFire()) list.add(new ComponentColor(new TextComponent("INCENDIARY"), 0xaa0000));
		return list;
	}
