...
import com.onewhohears.dscombat.data.vehicle.VehicleClientPreset;
import com.onewhohears.dscombat.data.vehicle.VehicleClientPreset.UIPos;
...
public class VehicleContainerMenu extends AbstractContainerMenu {
	...
	private VehicleClientPreset clientData;
	...
	public VehicleContainerMenu(int id, Inventory playerInv) {
		...
		if (playerInv.player.getRootVehicle() instanceof EntityVehicle plane) {
			...
			clientData = VehicleClientPresets.get().getPreset(plane.clientPresetId);
	...
	public VehicleClientPreset getClientData() {
		return clientData;
	}
