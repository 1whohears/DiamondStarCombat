package com.onewhohears.dscombat.data.vehicle.presets.boat;
...
public class BoatPresets {
	...
	public static final VehicleStats EMPTY_NATHAN_BOAT = VehicleStats.Builder
			...
			.setHardCodedRotAcc(0, 0, 0.1f, 0.05f)
			.setTurnTorques(0f, 0f, 2E5f)
			.setThrottleRate(0.05f, 0.10f)
			.setBasicEngineSounds(ModSounds.BOAT_1, ModSounds.BOAT_1)
			.setRotationalInertia(6E3f, 10E3f, 4E3f)
			.setPushEngineOverrideStats(10000, 5, 0.004f)
			.setUseSpeedScales(false, true)
			.setBreakDeAcc(0, 0.05f)
			.setCrashExplosionRadius(2)
			.set3rdPersonCamDist(4)
			.setCanNegativeThrottle(true)
			.setReverseSpeedMultiplier(0.3f)
			...
			.addSeatSlot("seat1", SlotType.MOUNT_LIGHT, 0.65, 1.2, 2.44)
			.addSeatSlot("seat2", SlotType.MOUNT_LIGHT, -0.65, 1.2, 2.44)
			.addSeatSlot("seat3", SlotType.MOUNT_LIGHT, 0.65, 1.2, 1.25)
	...
	public static final VehicleStats DEFAULT_NATHAN_BOAT = VehicleStats.Builder
	...
	public static final VehicleStats EMPTY_GRONK_BATTLESHIP = VehicleStats.Builder
			...
			.setHardCodedRotAcc(0, 0, 0.01f, 0.025f)
			.setTurnTorques(0f, 0f, 1E5f)
			.setThrottleRate(0.05f, 0.10f)
			.setBasicEngineSounds(ModSounds.BOAT_1, ModSounds.BOAT_1)
			.setRotationalInertia(6E4f, 10E5f, 4E5f)
			.setPushEngineOverrideStats(50000, 10, 0.019f)
			.setUseSpeedScales(false, true)
			.setBreakDeAcc(0, 0.05f)
			...
			.addEmptySlot("seat5", SlotType.MOUNT_SUPER_HEAVY, 0, 5, 11.5, 0)
			.addEmptySlot("seat6", SlotType.MOUNT_SUPER_HEAVY, 0, 5, -12, 0)
			.addEmptySlot("seat7", SlotType.MOUNT_SUPER_HEAVY, 0, 4, 18, 0)
			.addEmptySlot("seat8", SlotType.MOUNT_SUPER_HEAVY, 0, 4, -19, 0)
			.addEmptySlot("seat9", SlotType.MOUNT_MED, 0, 6, 7, 0)
			.addEmptySlot("seat10", SlotType.MOUNT_MED, 0, 6, -7, 0)
			.addEmptySlot("frame_1", SlotType.MOUNT_TECH, 0, 9, 3, 0)
			.addEmptySlot("frame_2", SlotType.MOUNT_LIGHT, 6, 4, 4, 0)
			.addEmptySlot("frame_3", SlotType.MOUNT_LIGHT, -6, 4, 4, 0)
			.addEmptySlot("frame_4", SlotType.MOUNT_LIGHT, 6, 4, -4, 0)
			.addEmptySlot("frame_5", SlotType.MOUNT_LIGHT, -6, 4, -4, 0)
			.addEmptySlot("internal_1", SlotType.RADIAL_ENGINE)
	...
	public static final VehicleStats DEFAULT_GRONK_BATTLESHIP = VehicleStats.Builder
	...
	public static final VehicleStats EMPTY_DESTROYER = VehicleStats.Builder
			...
			.addEmptySlot("seat5", SlotType.MOUNT_HEAVY, 0, 4, 11, 0)
			.addEmptySlot("seat6", SlotType.MOUNT_SUPER_HEAVY, 0, 4, -10, 0)
			.addEmptySlot("frame_1", SlotType.MOUNT_TECH, 0, 7, 2, 0)
			.addEmptySlot("frame_2", SlotType.MOUNT_LIGHT, 0, 7, 5.5, 0)
			.addEmptySlot("frame_3", SlotType.MOUNT_LIGHT, 3.5, 4, -2, 0)
			.addEmptySlot("frame_4", SlotType.MOUNT_LIGHT, -3.5, 4, -2, 0)
			.addEmptySlot("frame_5", SlotType.MOUNT_MED, 3.5, 4, -6, 0)
			.addEmptySlot("frame_6", SlotType.MOUNT_MED, -3.5, 4, -6, 0)
			.addEmptySlot("internal_1", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_2", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_3", SlotType.INTERNAL)
			.addEmptySlot("internal_4", SlotType.INTERNAL)
	...
	public static final VehicleStats EMPTY_CRUISER = VehicleStats.Builder
			...
			.addEmptySlot("seat5", SlotType.MOUNT_HEAVY, 0, 5, 9, 0)
			.addEmptySlot("seat6", SlotType.MOUNT_HEAVY, 0, 4, 15, 0)
			.addEmptySlot("seat7", SlotType.MOUNT_SUPER_HEAVY, 0, 4, -14, 0)
			.addEmptySlot("seat8", SlotType.MOUNT_LIGHT, 0, 5, -8, 0)
			.addEmptySlot("frame_1", SlotType.MOUNT_TECH, 0, 8, 0.5, 0)
			.addEmptySlot("frame_2", SlotType.MOUNT_MED, 0, 8, 4.5, 0)
			.addEmptySlot("frame_3", SlotType.MOUNT_LIGHT, 5, 4, -9, 0)
			.addEmptySlot("frame_4", SlotType.MOUNT_LIGHT, -5, 4, -9, 0)
			.addEmptySlot("frame_5", SlotType.MOUNT_MED, 5, 4, -3, 0)
			.addEmptySlot("frame_6", SlotType.MOUNT_MED, -5, 4, -3, 0)
			.addEmptySlot("internal_1", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_2", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_3", SlotType.INTERNAL)
			.addEmptySlot("internal_4", SlotType.INTERNAL)
			...
			.addEmptySlot("internal_10", SlotType.TECH_INTERNAL)
	...
	public static final VehicleStats EMPTY_CORVETTE = VehicleStats.Builder
			...
			.setArmorAbsorbtionPercent(0.35f)
			.setMass(50000f)
			.setMaxSpeed(0.95f)
			.setStealth(0.8f)
			.setCrossSecArea(4.5f)
			...
			.addEmptySlot("seat5", SlotType.MOUNT_MED, 0, 3, 5, 0)
			.addEmptySlot("seat6", SlotType.MOUNT_HEAVY, 0, 3, -7, 0)
			.addEmptySlot("frame_1", SlotType.MOUNT_TECH, 0, 5.5, -3.5, 0)
			.addEmptySlot("frame_2", SlotType.MOUNT_LIGHT, 0, 6, 0.5, 0)
			.addEmptySlot("internal_1", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_2", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_3", SlotType.INTERNAL)
			.addEmptySlot("internal_4", SlotType.INTERNAL)
	...
	public static final VehicleStats DEFAULT_CORVETTE = VehicleStats.Builder
	...
	public static final VehicleStats EMPTY_AIRCRAFT_CARRIER = VehicleStats.Builder
			...
			.setAssetId("aircraft_carrier")
			.setSortFactor(5)
			.setItem(ModItems.VEHICLE.getId())
			.setMaxHealth(200f)
			.setBaseArmor(600f)
			.setArmorDamageThreshold(10f)
			.setArmorAbsorbtionPercent(0.45f)
			.setMass(800000f)
			.setMaxSpeed(0.25f)
			.setStealth(1.2f)
			...
			.setHardCodedRotAcc(0, 0, 0.005f, 0.025f)
			.setTurnTorques(0f, 0f, 2E5f)
			.setThrottleRate(0.05f, 0.10f)
			.setBasicEngineSounds(ModSounds.BOAT_1, ModSounds.BOAT_1)
			.setRotationalInertia(6E4f, 10E5f, 4E5f)
			...
			.addEmptySlot("seat9", SlotType.MOUNT_HEAVY, -9, 6, 7.5, 0)
			.addEmptySlot("seat10", SlotType.MOUNT_HEAVY, -9, 6, -7, 0)
			.addEmptySlot("frame_1", SlotType.MOUNT_TECH, -9, 10, 3, 0)
			.addEmptySlot("frame_2", SlotType.MOUNT_MED, 9, 6, 8, 0)
			.addEmptySlot("frame_3", SlotType.MOUNT_MED, 9, 6, 0, 0)
			.addEmptySlot("frame_4", SlotType.MOUNT_MED, 9, 6, -8, 0)
			.addEmptySlot("internal_1", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_2", SlotType.RADIAL_ENGINE)
			.addEmptySlot("internal_3", SlotType.INTERNAL)
			.addEmptySlot("internal_4", SlotType.INTERNAL)
