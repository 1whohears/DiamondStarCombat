...
public class DefaultAircraftPresets {
	...
	public static final AircraftPreset EMPTY_ALEXIS_PLANE = AircraftPreset.Builder
			...
			.setDefaultTexture(DyeColor.WHITE, "dscombat:textures/entities/alexis_plane/v3_template.png")
			...
			.addPilotSeatSlot(0, 0.55, 6.5, 48, 20)
			...
			.addEmptySlot("slotname.dscombat.right_wing_2", SlotType.WING, -3.2, -0.3, 0.5, 0, 68, 60)
	...
	public static final AircraftPreset UNARMED_ALEXIS_PLANE = AircraftPreset.Builder
			...
			.setSlotItem("slotname.dscombat.internal_6", ModItems.DATA_LINK.getId())
	...
	public static final AircraftPreset SUPPORT_ALEXIS_PLANE = AircraftPreset.Builder
			...
			.setCraftable()
			.setSlotItem("slotname.dscombat.left_wing_1", ModItems.HEAVY_MISSILE_RACK.getId(), "agm84e", true)
			.setSlotItem("slotname.dscombat.left_wing_2", ModItems.HEAVY_MISSILE_RACK.getId(), "aim120b", true)
			.setSlotItem("slotname.dscombat.right_wing_1", ModItems.HEAVY_MISSILE_RACK.getId(), "rifel1", true)
			.setSlotItem("slotname.dscombat.right_wing_2", ModItems.LIGHT_MISSILE_RACK.getId(), "agm114k", true)
			.setSlotItem("slotname.dscombat.frame_1", ModItems.XM12.getId(), "50mmhe", true)
			.setSlotItem("slotname.dscombat.internal_4", ModItems.AR2K.getId())
			.setSlotItem("slotname.dscombat.internal_5", ModItems.GR400.getId())
			.addIngredient(ModItems.AR2K.getId())
	...
	public static final AircraftPreset SNIPER_ALEXIS_PLANE = AircraftPreset.Builder
			...
			.setCraftable()
			.setSlotItem("slotname.dscombat.left_wing_1", ModItems.HEAVY_MISSILE_RACK.getId(), "aim7mh", true)
			.setSlotItem("slotname.dscombat.left_wing_2", ModItems.HEAVY_MISSILE_RACK.getId(), "aim120c", true)
			.setSlotItem("slotname.dscombat.right_wing_1", ModItems.HEAVY_MISSILE_RACK.getId(), "aim7f", true)
			.setSlotItem("slotname.dscombat.right_wing_2", ModItems.HEAVY_MISSILE_RACK.getId(), "aim120b", true)
			.setSlotItem("slotname.dscombat.frame_1", ModItems.LIGHT_MISSILE_RACK.getId(), "aim9x", true)
			.setSlotItem("slotname.dscombat.internal_4", ModItems.AR2K.getId())
			.addIngredient(ModItems.AR2K.getId())
	...
	public static final AircraftPreset DEFAULT_JAVI_PLANE = AircraftPreset.Builder
			...
			.setSlotItem("slotname.dscombat.frame_1", ModItems.XM12.getId(), "50mmhe", true)
			.setSlotItem("slotname.dscombat.frame_2", ModItems.BOMB_RACK.getId(), "anm57", true)
			.setSlotItem("slotname.dscombat.internal_5", ModItems.GR400.getId())
			.addIngredient(ModItems.GR400.getId())
			.addIngredient(ModItems.HEAVY_MISSILE_RACK.getId(), 2)
			.addIngredient(ModItems.LIGHT_MISSILE_RACK.getId(), 2)
	...
	public static final AircraftPreset BOMBER_JAVI_PLANE = AircraftPreset.Builder
			...
			.setCraftable()
			.setSlotItem("slotname.dscombat.left_wing_1", ModItems.BOMB_RACK.getId(), "anm30", true)
			.setSlotItem("slotname.dscombat.left_wing_2", ModItems.HEAVY_MISSILE_RACK.getId(), "agm84e", true)
			.setSlotItem("slotname.dscombat.left_wing_3", ModItems.LIGHT_MISSILE_RACK.getId(), "agm114k", true)
			.setSlotItem("slotname.dscombat.left_wing_4", ModItems.LIGHT_MISSILE_RACK.getId(), "aim9l", true)
			.setSlotItem("slotname.dscombat.right_wing_1", ModItems.BOMB_RACK.getId(), "anm64", true)
			.setSlotItem("slotname.dscombat.right_wing_2", ModItems.HEAVY_MISSILE_RACK.getId(), "agm65g", true)
			.setSlotItem("slotname.dscombat.right_wing_3", ModItems.HEAVY_MISSILE_RACK.getId(), "agm65l", true)
			.setSlotItem("slotname.dscombat.frame_1", ModItems.XM12.getId(), "50mmhe", true)
			.setSlotItem("slotname.dscombat.frame_2", ModItems.HEAVY_MISSILE_RACK.getId(), "rifel1", true)
			.setSlotItem("slotname.dscombat.internal_5", ModItems.GPR20.getId())
	...
	public static final AircraftPreset TRUCK_JAVI_PLANE = AircraftPreset.Builder
			...
			.setCraftable()
			.setSlotItem("slotname.dscombat.left_wing_1", ModItems.HEAVY_MISSILE_RACK.getId(), "aim7mh", true)
			.setSlotItem("slotname.dscombat.left_wing_2", ModItems.HEAVY_MISSILE_RACK.getId(), "aim7f", true)
			.setSlotItem("slotname.dscombat.left_wing_3", ModItems.HEAVY_MISSILE_RACK.getId(), "aim120c", true)
			.setSlotItem("slotname.dscombat.left_wing_4", ModItems.HEAVY_MISSILE_RACK.getId(), "aim120b", true)
			.setSlotItem("slotname.dscombat.right_wing_1", ModItems.HEAVY_MISSILE_RACK.getId(), "aim7mh", true)
			.setSlotItem("slotname.dscombat.right_wing_2", ModItems.HEAVY_MISSILE_RACK.getId(), "aim7f", true)
			.setSlotItem("slotname.dscombat.right_wing_3", ModItems.HEAVY_MISSILE_RACK.getId(), "aim120c", true)
			.setSlotItem("slotname.dscombat.right_wing_4", ModItems.HEAVY_MISSILE_RACK.getId(), "aim120b", true)
			.setSlotItem("slotname.dscombat.frame_1", ModItems.XM12.getId(), "20mm", true)
			.setSlotItem("slotname.dscombat.frame_2", ModItems.LIGHT_MISSILE_RACK.getId(), "aim9p5", true)
			.setSlotItem("slotname.dscombat.internal_5", ModItems.AR2K.getId())
			.setSlotItem("slotname.dscombat.internal_6", ModItems.DATA_LINK.getId())
			.addIngredient(ModItems.AR2K.getId())
