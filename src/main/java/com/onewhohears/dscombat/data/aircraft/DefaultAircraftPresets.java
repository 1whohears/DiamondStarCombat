...
public class DefaultAircraftPresets {
	...
	public static final AircraftPreset EMPTY_JAVI_PLANE = AircraftPreset.Builder
			...
			.addEmptySlot("frame_1", SlotType.FRAME, 0, -0.7, 3, 0)
			.addEmptySlot("frame_2", SlotType.FRAME, 0, -0.7, 0, 0)
			.addEmptySlot("internal_1", SlotType.PUSH_ENGINE)
	...
	public static final AircraftPreset EMPTY_GRONK_BATTLESHIP = AircraftPreset.Builder
			...
			.addSeatSlot("seat9", SlotType.MED_TURRET, 0, 6, 7)
			.addSeatSlot("seat10", SlotType.MED_TURRET, 0, 6, -7)
			.addEmptySlot("frame_1", SlotType.ADVANCED_FRAME, 0, 9, 3, 0)
			.addEmptySlot("frame_2", SlotType.LIGHT_TURRET, 6, 4, 2, 0)
			.addEmptySlot("frame_3", SlotType.LIGHT_TURRET, -6, 4, 2, 0)
			.addEmptySlot("frame_4", SlotType.LIGHT_TURRET, 6, 4, -2, 0)
			.addEmptySlot("frame_5", SlotType.LIGHT_TURRET, -6, 4, -2, 0)
			.addEmptySlot("internal_1", SlotType.PUSH_ENGINE)
			.addEmptySlot("internal_2", SlotType.PUSH_ENGINE)
			.addEmptySlot("internal_3", SlotType.INTERNAL)
			.addEmptySlot("internal_4", SlotType.INTERNAL)
	...
	public static final AircraftPreset DEFAULT_GRONK_BATTLESHIP = AircraftPreset.Builder
			...
			.setSlotItem("seat6", ModItems.VLS.getId(), "bgm109", true)
			.setSlotItem("seat7", ModItems.TORPEDO_TUBES.getId())
			.setSlotItem("seat8", ModItems.MLS.getId())
			.setSlotItem("seat9", ModItems.MINIGUN_TURRET.getId())
			.setSlotItem("seat10", ModItems.MINIGUN_TURRET.getId())
			.addIngredient(ModItems.ADL.getId())
			.addIngredient(ModItems.VLS.getId())
			.addIngredient(ModItems.TORPEDO_TUBES.getId())
			.addIngredient(ModItems.MLS.getId())
			.addIngredient(ModItems.MINIGUN_TURRET.getId(), 2)
			.addIngredient("minecraft:copper_ingot", 64)
			.addIngredient("minecraft:iron_ingot", 64)
