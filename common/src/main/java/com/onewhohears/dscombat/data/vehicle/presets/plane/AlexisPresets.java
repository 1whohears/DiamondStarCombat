...
public class AlexisPresets {
	...
	public static final VehicleStats EMPTY_ALEXIS_PLANE = VehicleStats.Builder
            ...
            .addEmptySlot("frame_1", SlotType.PYLON_MED, 0, -0.7, -0.1, 180)
            .addEmptySlot("left_tech_mount", SlotType.PYLON_LIGHT, 0.685, -0.685, 4, 180)
            .addEmptySlot("right_tech_mount", SlotType.PYLON_LIGHT, -0.685, -0.685, 4, 180)
