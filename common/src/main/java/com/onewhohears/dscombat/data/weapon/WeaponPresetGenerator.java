...
public class WeaponPresetGenerator extends JsonPresetGenerator<WeaponStats>{
	...
	protected void registerAAMissiles() {
		...
		addPresetToGenerate(MissileStats.Builder
				...
				.setMaxAge(729)
				.setFuelTicks(60)
				.setTurnRadius(200f * 8)
				.setAcceleration(0.07f * 8)
				.setBleed(0.12f * 8)
				.setFuseDistance(8f)
				.setFieldOfView(-1f)
				.setTargetType(TargetDomainType.AIR)
	...
	protected void registerAGMissiles() {
		...
		addPresetToGenerate(MissileStats.Builder
				...
				.setTargetDomainType(TargetDomainType.GROUND)
				.setSortFactor(1)
				.setMass(45f)
				.setFireRate(20)
				.setInaccuracy(0f)
	...
	protected void registerOtherMissiles() {
		...
		addPresetToGenerate(MissileStats.Builder
				...
				.setTargetType(TargetDomainType.WATER)
				.setItem(ModItems.MISSILE.getId())
