...
public class DSCPhyCons {
    ...
    /**
     * @return speed of sound in meters per tick
     */
    public static float getVelSound() {
        return (float) (17.0145 * getIRLScale());
    }
	...
	public static final double MISSILE_BLEED_SCALE = 0.5;
	public static final double MISSILE_AIR_RES_SCALE = 0.05;
