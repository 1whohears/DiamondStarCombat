...
public class JaviPresets {
	...
	public static final AircraftPreset EMPTY_JAVI_PLANE = AircraftPreset.Builder
			...
			.addPilotSeatSlot(0, 0.5, 5.34375)
			.addEmptySlot("left_wing_1", SlotType.WING, 1.96875, -0.28125, 0, 180)
			.addEmptySlot("left_wing_2", SlotType.WING, 4.25, -0.28125, 0, 180)
			.addEmptySlot("left_wing_3", SlotType.WING, 5.625, -0.28125, 0, 180) 
			.addEmptySlot("left_wing_4", SlotType.WING, 6.96875, -0.28125, 0, 180) 
			.addEmptySlot("right_wing_1", SlotType.WING, -1.96875, -0.28125, 0, 180)
			.addEmptySlot("right_wing_2", SlotType.WING, -4.25, -0.28125, 0, 180)
			.addEmptySlot("right_wing_3", SlotType.WING, -5.625, -0.28125, 0, 180) 
			.addEmptySlot("right_wing_4", SlotType.WING, -6.96875, -0.28125, 0, 180) 
			.addEmptySlot("frame_1", SlotType.FRAME, 0, -0.34375, 7.65625, 180)
			.addEmptySlot("frame_2", SlotType.FRAME, 0, -0.71875, 0.03125, 180)
