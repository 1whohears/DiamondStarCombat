...
public class TankPresets {
	...
	public static final VehicleStats EMPTY_MRBUDGER_TANK = VehicleStats.Builder
			...
			.setArmorAbsorbtionPercent(0.50f)
			.setMass(15000f)
			.setMaxSpeed(0.3f)
			.setBreakDeAcc(0.1f, 0)
			.setStealth(1.0f)
			...
			.setTurnTorques(0f, 0f, 75000f)
			.setThrottleRate(0.04f, 0.04f)
			.setBasicEngineSounds(ModSounds.TANK_1, ModSounds.TANK_1)
			.setIdleEngineSounds(ModSounds.TANK_IDLE)
			.setRotationalInertia(8E3f, 12E4f, 8E4f)
			.setHardCodedRotAcc(0, 0, 0.05f, 0.1f)
			.setCrashExplosionRadius(3)
			.set3rdPersonCamDist(4)
			.setCarIsTank(true)
			.setCanNegativeThrottle(true)
			.setReverseSpeedMultiplier(0.4f)
			// Включаем динамические текстуры гусениц
			.setTrackTextures(true, -1.5, -0.8, 0.0, 1.5, -0.8, 0.0)
			.addExhaustSmokePos(-0.8, 1.5, -2.5)
			.addExhaustSmokePos(0.8, 1.5, -2.5)
	...
	public static final VehicleStats EMPTY_SMALL_ROLLER = VehicleStats.Builder
			...
			.setTurnTorques(0f, 0f, 6000f)
			.setThrottleRate(0.08f, 0.08f)
			.setBasicEngineSounds(ModSounds.TANK_1, ModSounds.TANK_1)
			.setRotationalInertia(8E3f, 12E4f, 8E4f)
			.setHardCodedRotAcc(0, 0, 0.1f, 0.1f)
			...
			.setReverseSpeedMultiplier(0.4f)
			// Включаем динамические текстуры гусениц
			.setTrackTextures(true, -0.7, -0.4, 0.0, 0.7, -0.4, 0.0)
