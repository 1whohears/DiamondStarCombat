...
public class ModEntities {
	...
	public static final RegistryObject<EntityType<EntityTurrent>> MINIGUN_TURRENT = ENTITIES.register("minigun_turrent", 
			() -> createEntityType((type, level) -> new EntityTurrent(type, level, "20mm"), 
