...
public class WeaponPresets {
	...
	public static void setupPresets() {
		add(new MissileData(ModEntities.MISSILE2, MISSILE2, ModSounds.MISSILE_LAUNCH_1,
		...
		add(new MissileData(ModEntities.MISSILE3, MISSILE3, ModSounds.MISSILE_LAUNCH_1,
		...
		add(new MissileData(ModEntities.MISSILE1, MISSILE1, ModSounds.MISSILE_LAUNCH_1,
				"gbu", Vec3.ZERO, 400, 8, 
		...
		add(new BulletData(ModEntities.BULLET, BULLET1, ModSounds.BULLET_SHOOT_1,
				"bullet_1", Vec3.ZERO, 
				200, 1000, 1, true, 
				15, 10, 0.5f));
