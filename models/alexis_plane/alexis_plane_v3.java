...
public class alexis_plane_v3<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Plane = partdefinition.addOrReplaceChild("Plane", CubeListBuilder.create(), PartPose.offset(-0.2517F, 0.0F, 0.0F));

		PartDefinition Cockpit = Plane.addOrReplaceChild("Cockpit", CubeListBuilder.create().texOffs(257, 246).addBox(-12.2483F, 20.0834F, -42.0F, 3.0F, 20.0F, 27.0F, new CubeDeformation(0.0F))
		.texOffs(569, 36).addBox(7.7517F, 20.0834F, -42.0F, 3.0F, 20.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 14.0F, 0.0F));
		...
		PartDefinition Seat = Cockpit.addOrReplaceChild("Seat", CubeListBuilder.create().texOffs(0, 24).addBox(-49.7483F, 21.0F, -5.0F, 12.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(41, 46).addBox(-49.7483F, 21.0F, 2.0F, 12.0F, 18.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(183, 70).addBox(-46.7483F, 37.0F, 3.0F, 6.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(43.0F, 5.0F, -23.0F));

		PartDefinition Controls = Cockpit.addOrReplaceChild("Controls", CubeListBuilder.create(), PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition controlstick = Controls.addOrReplaceChild("controlstick", CubeListBuilder.create().texOffs(0, 0).addBox(-1.25F, 11.25F, -1.5F, 2.5F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(32, 170).addBox(-1.0F, -1.75F, -1.0F, 2.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.7483F, 29.0032F, -30.7861F));
		...
		PartDefinition Body = Plane.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 309).addBox(-9.2483F, 16.0834F, -42.0F, 17.0F, 6.0F, 59.0F, new CubeDeformation(0.0F))
		.texOffs(0, 230).addBox(-12.2483F, 16.0834F, 17.0F, 23.0F, 24.0F, 211.0F, new CubeDeformation(0.0F))
		.texOffs(125, 548).addBox(-12.2483F, 16.0834F, -49.0F, 23.0F, 24.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(84, 230).addBox(-12.2483F, 16.0834F, -15.0F, 23.0F, 24.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 18.0F, 0.0F));

		PartDefinition intake_left = Body.addOrReplaceChild("intake_left", CubeListBuilder.create().texOffs(99, 394).addBox(-9.2483F, 2.0834F, -17.3F, 17.0F, 2.0F, 35.0F, new CubeDeformation(0.0F))
		.texOffs(359, 362).addBox(-0.7955F, 11.1397F, -17.3F, 18.25F, 2.0F, 35.0F, new CubeDeformation(0.0F))
		.texOffs(344, 325).addBox(-18.9511F, 11.1397F, -17.3F, 18.25F, 2.0F, 35.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = intake_right.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -7.0F, -17.75F, 2.0F, 8.0F, 37.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.2702F, 19.5684F, 1.096F, 0.1436F, 0.5053F, 0.2902F));

		PartDefinition cube_r4 = intake_right.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(102, 465).addBox(-1.0F, -7.0F, -17.75F, 2.0F, 8.0F, 37.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.7737F, 19.5684F, 1.096F, 0.1436F, -0.5053F, -0.2902F));
		...
		PartDefinition hull = Body.addOrReplaceChild("hull", CubeListBuilder.create().texOffs(454, 475).addBox(-9.2483F, 2.0834F, -10.3F, 17.0F, 13.0F, 186.0F, new CubeDeformation(0.0F))
		.texOffs(0, 475).addBox(-20.9983F, 14.5684F, -10.3F, 40.5F, 10.0F, 186.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 28.0F));
		...
		PartDefinition nose = Plane.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(341, 246).addBox(-12.2483F, -11.9166F, -30.0F, 23.0F, 13.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 46.0F, -51.0F));

		PartDefinition x_centered_r1 = nose.addOrReplaceChild("x_centered_r1", CubeListBuilder.create().texOffs(257, 325).addBox(-11.575F, -4.5F, -20.0F, 23.15F, 10.0F, 41.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7483F, -0.1299F, -15.1198F, 0.3071F, 0.0F, 0.0F));
		...
		PartDefinition wings = Plane.addOrReplaceChild("wings", CubeListBuilder.create().texOffs(0, 0).addBox(-24.7483F, 23.7008F, 3.8978F, 48.0F, 6.0F, 224.0F, new CubeDeformation(0.0F))
		.texOffs(506, 418).addBox(-79.2483F, 23.775F, 85.4611F, 157.0F, 6.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 14.0F, 0.0F));
		...
		PartDefinition Lwing = wings.addOrReplaceChild("Lwing", CubeListBuilder.create().texOffs(320, 129).addBox(77.5085F, 23.7708F, 92.4611F, 35.0F, 2.0F, 42.0F, new CubeDeformation(0.0F))
		.texOffs(257, 376).addBox(77.5085F, 25.7008F, 102.4611F, 35.0F, 4.0F, 32.0F, new CubeDeformation(0.0F))
		.texOffs(257, 246).addBox(112.4335F, 23.3508F, 67.4611F, 6.0F, 7.0F, 72.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Rwing = wings.addOrReplaceChild("Rwing", CubeListBuilder.create().texOffs(320, 85).addBox(-112.5085F, 23.7708F, 92.4611F, 35.0F, 2.0F, 42.0F, new CubeDeformation(0.0F))
		.texOffs(0, 374).addBox(-112.5085F, 25.7008F, 102.4611F, 35.0F, 4.0F, 32.0F, new CubeDeformation(0.0F))
		.texOffs(0, 230).addBox(-118.4335F, 23.3508F, 67.4611F, 6.0F, 7.0F, 72.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.4966F, 0.0F, 0.0F));
		...
		PartDefinition tail = Plane.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(94, 0).addBox(-8.4317F, -20.215F, -43.4791F, 7.5F, 15.0F, 55.0F, new CubeDeformation(0.0F))
		.texOffs(79, 619).addBox(-8.1817F, -18.215F, 11.5209F, 7.0F, 13.0F, 21.0F, new CubeDeformation(0.0F))
		.texOffs(477, 31).addBox(14.7139F, -40.5975F, 13.457F, 5.0F, 6.0F, 22.0F, new CubeDeformation(0.0F))
		.texOffs(268, 475).addBox(-29.0773F, -40.5975F, 13.457F, 5.0F, 6.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offset(4.9334F, 78.2983F, 214.4791F));
		...
		PartDefinition setF = gear.addOrReplaceChild("setF", CubeListBuilder.create().texOffs(16, 155).addBox(-2.0F, -18.5F, -2.0F, 4.0F, 25.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(124, 0).addBox(-6.0F, -20.5F, -4.0F, 4.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(94, 0).addBox(2.0F, -20.5F, -4.0F, 4.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 20.5F, 23.0F));

		PartDefinition setL = gear.addOrReplaceChild("setL", CubeListBuilder.create().texOffs(42, 0).addBox(16.067F, -21.5F, -6.0F, 6.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(6.6813F, 21.5F, 113.0F));
		...
		PartDefinition setR = gear.addOrReplaceChild("setR", CubeListBuilder.create().texOffs(0, 0).addBox(-22.067F, -21.5F, -6.0F, 6.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.6813F, 21.5F, 113.0F));
		...
		PartDefinition hexadecagon = Afterburner2.addOrReplaceChild("hexadecagon", CubeListBuilder.create().texOffs(557, 221).addBox(-3.5F, -16.5957F, -21.0F, 7.0F, 4.0F, 33.0F, new CubeDeformation(0.0F))
		.texOffs(645, 32).addBox(13.5957F, -2.5F, -12.0F, 4.0F, 7.0F, 24.0F, new CubeDeformation(0.0F))
		.texOffs(111, 629).addBox(-17.5957F, -2.5F, -12.0F, 4.0F, 7.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 41.0F, 225.0F));
		...
		.texOffs(560, 358).addBox(-3.5F, -17.5957F, -20.0F, 7.0F, 4.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
		...
		.texOffs(569, 0).addBox(-3.5F, -17.5957F, -20.0F, 7.0F, 4.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition hexadecagon_r6 = hexadecagon.addOrReplaceChild("hexadecagon_r6", CubeListBuilder.create().texOffs(604, 221).addBox(-3.5F, -17.5957F, -13.0F, 7.0F, 4.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition hexadecagon_r7 = hexadecagon.addOrReplaceChild("hexadecagon_r7", CubeListBuilder.create().texOffs(606, 358).addBox(-3.5F, -17.5957F, -13.0F, 7.0F, 4.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition cube_r45 = hull_connector.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(413, 294).addBox(-1.5F, -1.0F, -12.0F, 3.0F, 6.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.6953F, 37.5684F, 214.9029F, 0.0F, 0.2618F, 0.0F));
		...
		PartDefinition cube_r48 = hull_connector.addOrReplaceChild("cube_r48", CubeListBuilder.create().texOffs(94, 0).addBox(-1.5F, -1.0F, -12.0F, 3.0F, 6.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(15.6953F, 37.5684F, 214.9029F, 0.0F, -0.2618F, 0.0F));
		...
		PartDefinition hexadecagon_r8 = hexadecagon.addOrReplaceChild("hexadecagon_r8", CubeListBuilder.create().texOffs(544, 587).addBox(-17.5957F, -3.5F, -20.0F, 4.0F, 7.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.3861F, 6.5031F, 3.7175F, 0.0F, 0.2182F, 0.3927F));

		PartDefinition hexadecagon_r9 = hexadecagon.addOrReplaceChild("hexadecagon_r9", CubeListBuilder.create().texOffs(608, 279).addBox(-17.5957F, -3.5F, -20.0F, 4.0F, 7.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0883F, 8.0F, 3.7175F, 0.0F, 0.2182F, 0.0F));

		PartDefinition hexadecagon_r10 = hexadecagon.addOrReplaceChild("hexadecagon_r10", CubeListBuilder.create().texOffs(610, 56).addBox(-17.5957F, -3.5F, -20.0F, 4.0F, 7.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.3861F, 9.4969F, 3.7175F, 0.0F, 0.2182F, -0.3927F));

		PartDefinition hexadecagon_r11 = hexadecagon.addOrReplaceChild("hexadecagon_r11", CubeListBuilder.create().texOffs(610, 90).addBox(13.5957F, -3.5F, -20.0F, 4.0F, 7.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.6139F, 9.4969F, 3.7175F, 0.0F, -0.2182F, 0.3927F));

		PartDefinition hexadecagon_r12 = hexadecagon.addOrReplaceChild("hexadecagon_r12", CubeListBuilder.create().texOffs(610, 124).addBox(13.5957F, -3.5F, -20.0F, 4.0F, 7.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.9117F, 8.0F, 3.7175F, 0.0F, -0.2182F, 0.0F));

		PartDefinition hexadecagon_r13 = hexadecagon.addOrReplaceChild("hexadecagon_r13", CubeListBuilder.create().texOffs(610, 313).addBox(13.5957F, -3.5F, -20.0F, 4.0F, 7.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.6139F, 6.5031F, 3.7175F, 0.0F, -0.2182F, -0.3927F));

		PartDefinition hexadecagon_r14 = hexadecagon.addOrReplaceChild("hexadecagon_r14", CubeListBuilder.create().texOffs(0, 46).addBox(-3.5F, 13.5957F, -20.0F, 7.0F, 4.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.766F, 5.234F, 3.7175F, -0.2182F, 0.0F, 0.7854F));

		PartDefinition hexadecagon_r15 = hexadecagon.addOrReplaceChild("hexadecagon_r15", CubeListBuilder.create().texOffs(48, 502).addBox(-3.5F, 13.5957F, -30.0F, 7.0F, 4.0F, 37.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.4969F, 4.3861F, 3.7175F, -0.2182F, 0.0F, 0.3927F));

		PartDefinition hexadecagon_r16 = hexadecagon.addOrReplaceChild("hexadecagon_r16", CubeListBuilder.create().texOffs(506, 287).addBox(-3.5F, 13.5957F, -28.0F, 7.0F, 4.0F, 35.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, 4.0883F, 3.7175F, -0.2182F, 0.0F, 0.0F));

		PartDefinition hexadecagon_r17 = hexadecagon.addOrReplaceChild("hexadecagon_r17", CubeListBuilder.create().texOffs(506, 246).addBox(-3.5F, 13.5957F, -30.0F, 7.0F, 4.0F, 37.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.5031F, 4.3861F, 3.7175F, -0.2182F, 0.0F, -0.3927F));

		PartDefinition hexadecagon_r18 = hexadecagon.addOrReplaceChild("hexadecagon_r18", CubeListBuilder.create().texOffs(461, 178).addBox(-3.5F, 13.5957F, -20.0F, 7.0F, 4.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.234F, 5.234F, 3.7175F, -0.2182F, 0.0F, -0.7854F));

		PartDefinition hexadecagon_r19 = hexadecagon.addOrReplaceChild("hexadecagon_r19", CubeListBuilder.create().texOffs(569, 83).addBox(-3.5F, -17.5957F, -20.0F, 7.0F, 4.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.234F, 10.766F, 3.7175F, 0.2182F, 0.0F, 0.7854F));

		PartDefinition hexadecagon_r20 = hexadecagon.addOrReplaceChild("hexadecagon_r20", CubeListBuilder.create().texOffs(569, 114).addBox(-3.5F, -17.5957F, -20.0F, 7.0F, 4.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.5031F, 11.6139F, 3.7175F, 0.2182F, 0.0F, 0.3927F));

		PartDefinition hexadecagon_r21 = hexadecagon.addOrReplaceChild("hexadecagon_r21", CubeListBuilder.create().texOffs(569, 145).addBox(-3.5F, -17.5957F, -20.0F, 7.0F, 4.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, 11.9117F, 3.7175F, 0.2182F, 0.0F, 0.0F));

		PartDefinition hexadecagon_r22 = hexadecagon.addOrReplaceChild("hexadecagon_r22", CubeListBuilder.create().texOffs(32, 572).addBox(-3.5F, -17.5957F, -20.0F, 7.0F, 4.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.4969F, 11.6139F, 3.7175F, 0.2182F, 0.0F, -0.3927F));

		PartDefinition hexadecagon_r23 = hexadecagon.addOrReplaceChild("hexadecagon_r23", CubeListBuilder.create().texOffs(73, 585).addBox(-3.5F, -17.5957F, -20.0F, 7.0F, 4.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.766F, 10.766F, 3.7175F, 0.2182F, 0.0F, -0.7854F));
