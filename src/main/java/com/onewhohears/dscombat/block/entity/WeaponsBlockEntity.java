...
public class WeaponsBlockEntity extends SyncedBlockEntity implements MenuProvider {
	
	private NonNullList<ItemStack> inventory = NonNullList.withSize(1, ItemStack.EMPTY);
	
	public WeaponsBlockEntity(BlockPos pos, BlockState blockState) {
		super(ModBlockEntities.WEAPONS_BLOCK_ENTITY.get(), pos, blockState);
	}
