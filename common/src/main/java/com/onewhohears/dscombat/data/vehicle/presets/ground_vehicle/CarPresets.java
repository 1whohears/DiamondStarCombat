...
public class CarPresets {
	...
	public static final VehicleStats DEFAULT_ORANGE_TESLA = VehicleStats.Builder
			...
			.setReverseSpeedMultiplier(0.5f)
    ...
    public static final VehicleStats EMPTY_WILLY_JEEP = VehicleStats.Builder
            .createCar(DSCombatMod.MODID, "willy_jeep_empty")
            .setAssetId("willy_jeep")
            .setSortFactor(4)
            .setItem(ModItems.VEHICLE.getId())
            .setMaxHealth(45)
            .setBaseArmor(45)
            ...
            .setThrottleRate(0.05f, 0.05f)
            .setBasicEngineSounds(ModSounds.TANK_1, ModSounds.TANK_1)
            .setRotationalInertia(7E3f, 10E4f, 7E4f)
            .setCrashExplosionRadius(3)
            .set3rdPersonCamDist(6)
            .setCarIsTank(false)
            .setCanNegativeThrottle(true)
            .setReverseSpeedMultiplier(0.5f)
            .addPilotSeatSlot(0.5, 0.4, -0.4)
            .addSeatSlot("seat2", -0.5, 0.4, -0.4)
            .addSeatSlot("seat3", 0.5, 0.5, -1.5)
            .addSeatSlot("seat4", -0.5, 0.5, -1.5)
            .addIngredient(ModItems.SEAT.getId(), 4)
            .addIngredient(ModItems.WHEEL.getId(), 4)
            ...
            .addEmptySlot("hitch_1", SlotType.EXTERNAL_TOUGH, 0, 0.59, -1.7, 180)
            .setEntityMainHitboxSize(2, 0.5f)
            .setRootHitboxNoCollide(true)
            .addRotableHitbox("body", 2.5, 1.5, 4.0, 0, 0.75, 0,
                    0, 0, false, false, true)
            .build();

    public static final VehicleStats DEFAULT_WILLY_JEEP = VehicleStats.Builder
            .createFromCopy(DSCombatMod.MODID, "willy_jeep", EMPTY_WILLY_JEEP)
            .setCraftable()
            .addIngredient(ModItems.C12_ENGINE.getId())
            .addIngredient(ModItems.HEAVY_FUEL_TANK.getId())
            .addIngredient(ModItems.CHAIN_HOOK.getId())
