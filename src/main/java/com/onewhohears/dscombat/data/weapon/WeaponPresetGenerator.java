...
public class WeaponPresetGenerator extends JsonPresetGenerator<WeaponStats>{
	...
	protected void registerBullets() {
		...
		addPresetToGenerate(BulletStats.Builder
				...
				.setCompatibleWeaponPart(ModItems.XM12.getId(), ModItems.INTERNAL_GUN.getId())
				.setCompatibleTurret(ModItems.MINIGUN_TURRET.getId())
				.setCraftNum(64)
		...
		addPresetToGenerate(BulletStats.Builder
				...
				.setShootSound(ModSounds.BULLET_SHOOT_1.getLocation())
				.setCompatibleWeaponPart(ModItems.XM12.getId(), ModItems.INTERNAL_GUN.getId())
				.setCompatibleTurret(ModItems.AA_TURRET.getId())
				.setCraftNum(48)
				.addIngredient("minecraft:copper_ingot", 4)
				.build());
		// max ammo cost: 63 copper
		addPresetToGenerate(BulletStats.Builder
				...
				.setShootSound(ModSounds.BULLET_SHOOT_1.getLocation())
				.setCompatibleWeaponPart(ModItems.XM12.getId(), ModItems.INTERNAL_GUN.getId())
				.setCompatibleTurret(ModItems.CIWS.getId())
				.setCraftNum(32)
				.addIngredient("minecraft:copper_ingot", 4)
				.build());
		addPresetToGenerate(BulletStats.Builder
		...
		addPresetToGenerate(BulletStats.Builder
				...
				.setEntityType(ModEntities.BULLET.getId())
				.setShootSound(ModSounds.BULLET_SHOOT_1.getLocation())
				.setCompatibleWeaponPart(ModItems.INTERNAL_GUN.getId())
				.setCraftNum(20)
		...
		addPresetToGenerate(BulletStats.Builder
				...
				.setNoRack()
				.setShootSound(ModSounds.BULLET_SHOOT_1.getLocation())
				.setCompatibleTurret(ModItems.HEAVY_TANK_TURRET.getId())
				.setCraftNum(1)
				.addIngredient("minecraft:copper_ingot", 4)
				.addIngredient("minecraft:gunpowder", 6)
				.build());
		addPresetToGenerate(BulletStats.Builder
				...
				.setNoRack()
				.setShootSound(ModSounds.BULLET_SHOOT_1.getLocation())
				.setCompatibleTurret(ModItems.MARK7_CANNON.getId())
				.setCraftNum(1)
		...
		addPresetToGenerate(BulletStats.Builder
				...
				.setNoRack()
				.setShootSound(ModSounds.BULLET_SHOOT_1.getLocation())
				.setCompatibleTurret(ModItems.MARK45_CANNON.getId())
				.setCraftNum(1)
	...
	protected void registerAAMissiles() {
		...
		addPresetToGenerate(MissileStats.Builder
				...
				.setCompatibleTurret(ModItems.STEVE_UP_SMASH.getId())
				.setCraftNum(1)
	...
	protected void registerAGMissiles() {
		...
		addPresetToGenerate(MissileStats.Builder
				...
				.setShootSound(ModSounds.MISSILE_LAUNCH_1.getLocation())
				.setCompatibleWeaponPart(ModItems.HEAVY_MISSILE_RACK.getId())
				.setCompatibleTurret(ModItems.MLS.getId())
				.setCraftNum(1)
				.addIngredientTag("dscombat:aluminum_ingot", 5)
	...
	protected void registerOtherMissiles() {
		...
		addPresetToGenerate(MissileStats.Builder
				...
				.setShootSound(ModSounds.MISSILE_LAUNCH_1.getLocation())
				.setCompatibleWeaponPart(ModItems.HEAVY_MISSILE_RACK.getId())
				.setCompatibleTurret(ModItems.TORPEDO_TUBES.getId())
				.setCraftNum(1)
				.addIngredientTag("dscombat:aluminum_ingot", 12)
		...
		addPresetToGenerate(MissileStats.Builder
				...
				.setShootSound(ModSounds.MISSILE_LAUNCH_1.getLocation())
				.setCompatibleWeaponPart(ModItems.ADL.getId(), ModItems.HEAVY_MISSILE_RACK.getId())
				.setCompatibleTurret(ModItems.MLS.getId())
				.setCraftNum(1)
				.addIngredientTag("dscombat:aluminum_ingot", 12)
