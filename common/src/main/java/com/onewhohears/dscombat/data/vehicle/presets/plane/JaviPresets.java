...
public class JaviPresets {
	...
	public static final VehicleStats EMPTY_JAVI_PLANE = VehicleStats.Builder
			...
			.addEmptySlot("frame_1", SlotType.PYLON_HEAVY, 0, -0.55, 1.03125, 180)
            .addEmptySlot("left_tech_mount", SlotType.PYLON_LIGHT, 0.67, -0.27, 6, 180)
            .addEmptySlot("right_tech_mount", SlotType.PYLON_LIGHT, -0.67, -0.27, 6, 180)
