...
public class DefaultAircraftPresets {
	...
	public static final AircraftPreset EMPTY_ALEXIS_PLANE = AircraftPreset.Builder
			...
			.addPilotSeatSlot(0, -0.3, 2)
			.addEmptySlot("left_wing_1", SlotType.WING, 1.8, -0.3, 0.5, 0)
			.addEmptySlot("left_wing_2", SlotType.WING, 3.2, -0.3, 0.5, 0)
			.addEmptySlot("right_wing_1", SlotType.WING, -1.8, -0.3, 0.5, 0)
			.addEmptySlot("right_wing_2", SlotType.WING, -3.2, -0.3, 0.5, 0)
			.addEmptySlot("frame_1", SlotType.FRAME, 0, -0.4, 2.5, 0)
	...
	public static final AircraftPreset EMPTY_JAVI_PLANE = AircraftPreset.Builder
			...
			.addIngredient("minecraft:gold_ingot", 10)
			.addPilotSeatSlot(0, -0.4, 3)
			.addSeatSlot("seat2", SlotType.TURRET, 0, -0.4, 2)
	...
	public static final AircraftPreset EMPTY_NOAH_CHOPPER = AircraftPreset.Builder
			...
			.addSeatSlot("seat2", SlotType.TURRET, -0.4, -0.65, 1.5)
			.addSeatSlot("seat3", SlotType.TURRET, 0.4, -0.65, 0.3)
			.addSeatSlot("seat4", SlotType.TURRET, -0.4, -0.65, 0.3)
	...
	public static final AircraftPreset EMPTY_NATHAN_BOAT = AircraftPreset.Builder
			...
			.addSeatSlot("seat1", SlotType.TURRET, 0.65, 1.2, 2.44)
			.addSeatSlot("seat2", SlotType.TURRET, -0.65, 1.2, 2.44)
			.addSeatSlot("seat3", SlotType.TURRET, 0.65, 1.2, 1.25)
			.addSeatSlot("seat4", SlotType.TURRET, -0.65, 1.2, 1.25)
			.addSeatSlot("seat5", SlotType.TURRET, 0.65, 1.2, -0.06)
			.addSeatSlot("seat6", SlotType.TURRET, -0.65, 1.2, -0.06)
