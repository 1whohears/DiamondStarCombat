...
public class AircraftClientPresetGenerator extends JsonPresetGenerator<AircraftClientPreset> {
	...
	protected void registerPresets() {
		...
		addPresetToGenerate(AircraftClientPreset.Builder.create(DSCombatMod.MODID, "gronk_battleship")
				...
				.addUIPos("seat5", gronk_middle_x, 40-18)
				.addUIPos("seat6", gronk_middle_x, 40+18*3)
				.addUIPos("seat7", gronk_middle_x, 40-18*2)
				.addUIPos("seat8", gronk_middle_x, 40+18*4)
				.addUIPos("frame_1", gronk_middle_x, 40+18)
				.addUIPos("frame_2", gronk_middle_x-50, 40)
				.addUIPos("frame_3", gronk_middle_x+50, 40)
				.addUIPos("frame_4", gronk_middle_x-50, 40+18*2)
				.addUIPos("frame_5", gronk_middle_x+50, 40+18*2)
				.addUIPos("internal_1", gronk_middle_x-18, 40+18*3)
				.addUIPos("internal_2", gronk_middle_x+18, 40+18*3)
