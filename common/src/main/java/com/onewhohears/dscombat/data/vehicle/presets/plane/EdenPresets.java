...
public class EdenPresets {
	...
	public static final VehicleStats EMPTY_EDEN_PLANE = VehicleStats.Builder
			...
			.addPilotSeatSlot(0, 0.3, 8.5, true)
			.addSeatSlot(PartSlot.COPILOT_SLOT_NAME, 0, 0.4, 6.8, true)
			.addEmptySlot("left_wing_1", SlotType.PYLON_MED, 3, 0.05, 0.4, 180, "left_wing")
			.addEmptySlot("left_wing_2", SlotType.PYLON_MED, 4, 0.05, -0.4, 180, "left_wing")
			.addEmptySlot("left_wing_3", SlotType.PYLON_LIGHT, 5, 0.05, -1.2, 180, "left_wing")
			.addEmptySlot("right_wing_1", SlotType.PYLON_MED, -3, 0.05, 0.4, 180, "right_wing")
			.addEmptySlot("right_wing_2", SlotType.PYLON_MED, -4, 0.05, -0.4, 180, "right_wing")
            ...
            .addEmptySlot("frame_1", SlotType.PYLON_MED, 0, 0, 0.4, 180)
            .addEmptySlot("left_tech_mount", SlotType.PYLON_LIGHT, 0.5, 0.1, 7, 180)
            .addEmptySlot("right_tech_mount", SlotType.PYLON_LIGHT, -0.5, 0.1, 7, 180)
