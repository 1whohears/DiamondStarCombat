package com.onewhohears.dscombat.data.vehicle.presets.submarine;
...
public class SubPresets {
	...
	public static final VehicleStats EMPTY_ANDOLF_SUB = VehicleStats.Builder
			...
			.setRotationalInertia(6E4f, 10E5f, 3E5f)
			.setHardCodedRotAcc(0.1f, 0.05f, 0.01f, 0.025f)
			.setSpinEngineOverrideStats(50000, 10, 0.019f)
